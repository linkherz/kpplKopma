           ...
           <!-- Sidebar Menu Items - These collapse to the responsive navigation menu on small screens -->
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="<?php echo base_url().'index.php/admin/transaksi';?>"><i class="fa fa-fw fa-bar-chart-o"></i> Transaksi</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url().'index.php/admin/lihatuser';?>"><i class="fa fa-fw fa-table"></i> Lihat Customer</a>
                    </li>
                    <li>
